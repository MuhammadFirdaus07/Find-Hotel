<footer class="container">
  <div class="row" style="margin-top: 100px;">
    <div class="col-3"> <span class="brand-text-icon">FIND HOTEL</span>
      <p class="p-footer">We provide what you need to enjoy your
        holiday with family.</p>
    </div>
    <div class="col-4">
      <span class="footer-title">About <p class="p-footer">FIND HOTEL akan membantu menghubungkan jutaan
          travellers dengan
  ...
  <p class="footer-last-text text-center">Copyright 2024 • All rights reserved • FIND HOTEL</p>
</footer>
</div>
</body>
